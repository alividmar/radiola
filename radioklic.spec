...
# radioklic.spec — PyInstaller konfiguracija za RadioKlic
# Poganjanje: pyinstaller radioklic.spec
...
# Ikona aplikacije
icon_file = None
if IS_WIN and os.path.isfile("radioklic.ico"):
    icon_file = "radioklic.ico"
elif IS_MAC and os.path.isfile("radioklic.icns"):
    icon_file = "radioklic.icns"
elif IS_LINUX and os.path.isfile("radioklic.png"):
    icon_file = "radioklic.png"
...
if IS_MAC:
    app = BUNDLE(
        ...
        name="RadioKlic.app",
        icon=icon_file,
        bundle_identifier="si.radioklic.app",
        info_plist={
